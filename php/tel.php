...
<head>
    ...
    <title>Accessoires pour téléphones portables</title>
...
<body>
    ...
    <h1>Coup d'oeil rapide sur les Cellulaires</h1>
    <?php
    $products = [
        ["image" => "../images/tel.jpg", "alt" => "Tel", "title" => "Spigen Slim Armor", "description" => "250$"],
        ["image" => "../images/tel1.jpg", "alt" => "Tel1", "title" => "Protection d'écran", "description" => "150$"]
    ];
    ?>
    <div class="container">
