...
<body>
    ...
    <h1>Coup d'oeil rapide sur les Accessoires pour jeux vidéo</h1>
    <?php
    $products = [
        ["image" => "../images/jeux.jpg", "alt" => "Jeux", "title" => "Manette sans fil ", "description" => "100$"],
        ["image" => "../images/jeux1.jpg", "alt" => "Jeux1", "title" => "Thrustmaster T598 ", "description" => "100$"]
    ];
    ?>
