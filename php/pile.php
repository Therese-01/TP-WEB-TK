...
<head>
    ...
    <title>Piles et Accessoires</title>
...
<body>
    ...
    <h1>Coup d'oeil rapide sur les Piles et les Accessoires</h1>
    <?php
    $products = [
        ["image" => "../images/pile2.webp", "alt" => "Pile", "title" => "Testeur de capacité de batterie", "description" => "10$"],
        ["image" => "../images/pile1.webp", "alt" => "Pile1", "title" => "Chargeur de batterie", "description" => "10$"]
    ];
    ?>
