...
<head>
    ...
    <title>Ordinateurs et Accessoires</title>
...
<body>
    ...
    <h1>Coup d'oeil rapide sur les Ordinateurs et Accessoires</h1>

    <?php
    $products = [
        ["image" => "../images/ordi.webp", "alt" => "Ordi", "title" => "Support double moniteur", "description" => "150$"],
        ["image" => "../images/ordi1.webp", "alt" => "Ordi1", "title" => "Support 2-en-1 Innovant", "description" => "150$"]
    ];
    ?>
