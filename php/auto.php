...
<body>
    ...
    <h1>Coup d'oeil rapide sur les Automobiles</h1>
    
    <?php
        $produits_auto = [
            ["image" => "../images/auto.webp", "alt" => "Auto", "nom" => "Lumières de tableau", "description" => "55$"],
            ["image" => "../images/auto1.webp", "alt" => "Auto1", "nom" => "Support de Voiture", "description" => "20$"]
        ];
    ?>

    <div class="container">
        <?php foreach ($produits_auto as $produit) : ?>
            <div class="card">
