...
<body>
    ...
    <?php
    $products = [
        ["image" => "../images/photo.webp", "alt" => "Photo", "title" => "Lunettes de Vision", "description" => "23$"],
        ["image" => "../images/photo1.webp", "alt" => "Photo1", "title" => "Ja-20 Nouvelle Vision", "description" => "23"]
    ];
    ?>
